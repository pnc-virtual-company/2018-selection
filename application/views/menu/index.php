...
<nav class="navbar navbar-expand-md bg-light navbar-light fixed-top sticky-top">
	<a class="navbar-brand" href="<?php echo base_url(); ?>candidates"><img src="<?php echo base_url();?>assets/images/system_img/logo.png" alt="Logo" class="img-fluid max-width"></a>
		...
		<ul class="navbar-nav mr-auto">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="<?php echo base_url() ?>candidates">List of candidates</a>
					<a class="dropdown-item" href="<?php echo base_url() ?>candidates/newCandidate">New candidate</a>
					<a class="dropdown-item" href="<?php echo base_url() ?>candidates/map">Province distribution</a>
				</div>
			</li>
					...
					<ul class="navbar-nav ml-auto">
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle waves-effect waves-light" id="navbarDropdownMenuLink-4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" href="#">
								...
								<?php }elseif ($role == 2) {?>
									<a class="dropdown-item waves-effect waves-light" href="<?php echo base_url() ?>Users/editNormalUser/<?php echo $this->session->id ?>">Edit profile</a>
								<?php
								} ?>
