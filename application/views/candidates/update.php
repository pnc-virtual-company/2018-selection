...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<div class="container">
										...
										<div class="col-lg-6 col-md-6 col-xs-12">
											<select class="form-control" name="grade" id="globalGrade">
												<?php foreach ($value as $values) { ?>
													<option value="A+" <?php if($values->candidate_global_grade == 'A+') echo 'selected="selected"'; ?>>A+</option>
													<option value="A" <?php if($values->candidate_global_grade == 'A') echo 'selected="selected"'; ?>>A</option>
													<option value="A-" <?php if($values->candidate_global_grade == 'A-') echo 'selected="selected"'; ?>>A-</option>
													<option value="B+" <?php if($values->candidate_global_grade == 'B+') echo 'selected="selected"'; ?>>B+</option>
													<option value="B" <?php if($values->candidate_global_grade == 'B') echo 'selected="selected"'; ?>>B</option>
													<option value="Failed" <?php if($values->candidate_global_grade == 'Failed') echo 'selected="selected"'; ?>>Failed</option>
												<?php } ?>
											</select>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-lg-5 col-md-5">
									<div class="form-group row">
										...
										<div class="col-lg-6 col-md-6 col-xs-12">
											<?php foreach ($value as $values) { ?>
												<input type="text" name="fname" id="fname" class="form-control" value="<?php echo $values->candidate_firstname; ?>" placeholder="firstname">
											<?php } ?>
										</div>
									</div>
								</div>
								<div class="col-lg-7 col-md-7">
									<div class="form-group row">
										...
										<div class="col-lg-5 col-md-5 col-xs-12">
											<?php foreach ($value as $values) { ?>
												<input type="text" name="lname" id="lname" class="form-control" value="<?php echo $values->candidate_lastname; ?>" placeholder="lastname">
											<?php } ?>
										</div>
									</div>
								</div>	
							...
							<div class="row">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6 col-md-6 col-xs-12">
											<select class="form-control" name="gender" id="gender">
												<?php foreach ($value as $values) { ?>
													<option value="Male" <?php if ($values->candidate_gender == 'Male') echo 'selected="selected"'; ?>>Male</option>
													<option value="Female" <?php if ($values->candidate_gender == 'Female') echo 'selected="selected"'; ?>>Female</option>
												<?php } ?>
											</select>
										</div>
									</div>
								...
								<div class="col-lg-7 col-md-7">
									<div class="form-group row">
										...
										<div class="col-lg-5 col-md-5 col-xs-12">
											<?php foreach ($value as $values) { ?>
												<input type="number" name="canAge" class="form-control" value="<?php echo $values->candidate_age ?>" id="age" placeholder="Your Age " required>
											<?php } ?>
										</div>
									</div>
								</div>
												...
												<?php foreach ($value as $values) { ?>
													...
													foreach ($provinces as $province) { ?>
														<option value="<?php echo $province; ?>"
															<?php 
															if ($province == $values->candidate_province) {
																?>
																selected="selected"
																<?php
															}
										...
										<div class="col-lg-6 col-md-6">
											<div class="form-group row">
												...
												<div class="col-lg-6 col-md-7 col-xs-12">
													<?php foreach ($value as $values) { ?>
														<input type="text" name="ngoComment" class="form-control" id="ngoOther" value="<?php echo $values->candidate_ngo_comment; ?>" placeholder="If other, please specify " required style="margin-left: -32px;width: 161%;">
													<?php } ?>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-lg-5 col-md-5">
											<div class="form-group row">
												...
												<div class="col-lg-6 col-md-6 col-xs-12">
													<select class="form-control" id="health" name="candidate_health">
														<?php foreach ($value as $values) { ?>
															<?php if ($values->candidate_healthy == 'Healthy') { ?>
										...
										<div class="col-lg-7 col-md-7">
											<div class="form-group row">
												...
												<div class="col-lg-8 col-md-8 col-xs-12">
													<?php foreach ($value as $values) { ?>
														<input type="text" class="form-control" name="healthIssues" value="<?php echo $values->candidate_health_comment; ?>" id="healthOther" placeholder="If some health issuses, please specify" required style="margin-left: -4px;">
													<?php } ?>
												<?php }else{ ?>
								...
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="form-group row">
											...
											<div class="col-lg-6 col-md-6 col-xs-12">
												<?php foreach ($value as $values) { ?>
													<input type="text" class="form-control" name="canRankClass" value="<?php echo $values->candidate_rank_inclass; ?>" id="rankClass" placeholder="Ex: 10/33" required>
												<?php } ?>
											</div>
										</div>
									</div>		
								...
								<div class="row">
									...
									<div class="col-lg-7 col-md-7">
										<div class="form-group row">
											...
											<div class="col-lg-8 col-md-8 col-xs-12">
												<?php foreach ($value as $values) { ?>
													<input type="text" class="form-control" name="canAchivement" value="<?php echo $values->candidate_activity_achivement; ?>" id="activityActivity" placeholder="please comment" style="margin-left: -4px;" required>
												<?php } ?>
											</div>
										</div>
									</div>
								...
								<div class="row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<select class="form-control" id="pncChoice" name="canPncRank">
													<?php foreach ($value as $values) { ?>
														<option value="1" <?php if($values->candidate_pn_choic_rank == '1') echo 'selected="selected"'; ?>>1</option>
														<option value="2" <?php if($values->candidate_pn_choic_rank == '2') echo 'selected="selected"'; ?>>2</option>
														<option value="3" <?php if($values->candidate_pn_choic_rank == '3') echo 'selected="selected"'; ?>>3</option>
														<option value="4" <?php if($values->candidate_pn_choic_rank == '4') echo 'selected="selected"'; ?>>4</option>
													<?php } ?>
												</select>
											</div>
										</div>
									...
									<div class="col-lg-6 col-md-6">
										<div class="form-group row">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<?php foreach ($value as $values) { ?>
													<input type="text" class="form-control" name="responsibilityMaturity" value="<?php echo $values->candidate_resposibility ?>" id="responsibility" placeholder="Ex: 18/20" required style="">
												<?php } ?>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-lg-6 col-md-6">
										<div class="form-group row">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<?php foreach ($value as $values) { ?>
													<input type="text" class="form-control" name="motivatForPnc" value="<?php echo $values->candidate_pnc_motivation ?>" id="motivation" placeholder="Ex: 18/20" required>
												<?php } ?>
											</div>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="form-group row">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<?php foreach ($value as $values) { ?>
													<input type="text" class="form-control" name="canCommunicate" value="<?php echo $values->candidate_communicate ?>" id="communication" placeholder="Ex: 10/10" required>
												<?php } ?>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="form-group row">
											...
											<div class="col-lg-6 col-md-6 col-xs-12">
												<?php foreach ($value as $values) { ?>
												<input type="text" class="form-control" name="alternative1" id="alter1" value="<?php echo $values->candidate_alternative1; ?>" placeholder="Other" required>
											<?php } ?>
											</div>
										</div>
									</div>
												...
												<select class="form-control" name="choiceRank1" id="choiceRank1">
													<?php if($value != NULL) {
													 foreach ($value as $values) {
														for ($i=1; $i <=4 ; $i++) { 
														?>
														<option value="<?php echo $i; ?>" <?php if($i == $values->candidate_rank_1) echo 'selected="selected"' ?>>
															<?php echo $i; ?>
														</option>
														<?php		
														}
								...
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="form-group row">
											...
											<div class="col-lg-6 col-md-6 col-xs-12">
												<?php foreach ($value as $values) { ?>
												<input type="text" class="form-control" name="alternative2" value="<?php echo $values->candidate_alternative2; ?>" id="alter2" placeholder="Other" required>
											<?php } ?>
											</div>
										</div>
									</div>
												...
												<select class="form-control" name="choiceRank2" id="choiceRank2">
													<?php if($value != NULL) {
													 foreach ($value as $values) {
														for ($i=1; $i <=4 ; $i++) { 
														?>
														<option value="<?php echo $i; ?>" <?php if($i == $values->candidate_rank_2) echo 'selected="selected"' ?>>
															<?php echo $i; ?>
														</option>
														<?php		
														}
								...
								<div class="row">
									<div class="col-lg-5 col-md-5">
										<div class="form-group row">
											...
											<div class="col-lg-6 col-md-6 col-xs-12">
												<?php foreach ($value as $values) { ?>
												<input type="text" class="form-control" name="alternative3" id="alter3" value="<?php echo $values->candidate_alternative3; ?>" placeholder="Other" required>
											<?php } ?>
											</div>
										</div>
									</div>
												...
												<select class="form-control" name="choiceRank3" id="choiceRank3">
													<?php if($value != NULL) {
													 foreach ($value as $values) {
														for ($i=1; $i <=4 ; $i++) {
														?>
														<option value="<?php echo $i; ?>" <?php if($i == $values->candidate_rank_3) echo 'selected="selected"' ?>>
															<?php echo $i; ?>
														</option>
														<?php		
														}
								...
								<div class="col-lg-7 col-md-7">
									<div class="form-group row">
										...
										<div class="col-lg-9 col-md-9 col-xs-12">
											<?php foreach ($value as $values) { ?>
												<input type="text" name="CanCommitment" class="form-control" value="<?php echo $values->candidate_student_commit ?>" id="studentCommit" placeholder="please comment" required>
											<?php } ?>
										</div>
									</div>
								</div>	
							...
							<div class="row">
								...
								<div class="col-lg-7 col-md-7">
									<div class="form-group row">
										...
										<div class="col-lg-9 col-md-9 col-xs-12">
											<?php foreach ($value as $values) { ?>
												<input type="text" class="form-control" name="canParentCommitment" value="<?php echo $values->candidate_parents_commit ?>" id="parentsCommit" placeholder="please comment" required>
											<?php } ?>
										</div>
									</div>
								</div>	
			...
			<script>
				$(document).ready(function(){
					$('#UpCanInfo').click(function(){
						...
						$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>candidates/uCandidateInfo/'+id,
		...
		$(document).ready(function(){
			$('#familyProfile').click(function(){
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url() ?>candidates/uFamilyProfile/'+id,
	...
	<script>
		$(document).ready(function(){
			$('#uParentIncome').click(function(){
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url() ?>candidates/uParentIncome/'+id,
			...
			<div class="card-body contentBody">
				<form method="POST" class="fExpenseSource">
					...
					<div class="row">
						...
						<div class="col-md-4"></div>
						<div class="col-md-4">
							<button type="button" class="btn btn-primary float-right" id="uFamilyExpenses">Update information</button>
						</div>
					</div>
					<!-- <?php //} ?> -->
				</form>
	...
	<script>
		$(document).ready(function(){
			$('#uFamilyExpenses').click(function(){
				var id = <?php echo $this->uri->segment(3); ?>;
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url() ?>candidates/uFamilyExpences/'+id,
						...
						<div class="col-lg-4 col-md-4">
							<div class="form-group row">
								...
								<div class="col-lg-7 col-md-7 col-xs-12">
									<?php if($loadAndDebt != NULL) { ?>
										<?php foreach ($loadAndDebt as $value) { ?>
											<input type="number" name="interestRates" value="<?php echo $value->ld_interest_rates; ?>" id="interest" class="form-control" placeholder="$" style="direction:rtl;" required>
										<?php } ?>
									<?php }else{ ?>
	...
	<script>
		$(document).ready(function(){
			$('#uloanDebt').click(function(){
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url() ?>candidates/uLoansDebts/'+id,
			...
			<div class="card-body contentBody">
				<form method="POST" class="uResidence">
					<div class="row">
						<div class="col-lg-4 col-md-4">
							<div class="form-group row">
								<!-- <input type="hidden" name="residenceID" value="<?php echo $value->res_id; ?>"> -->
									...
									<select name="status" id="status" class="form-control">
										<?php if ($residence != NULL ) { ?>
											<?php foreach ($residence as $value) { ?>
												<option value="Inherited" <?php if($value->res_status == 'Inherited') echo 'selected="selected"'; ?>>Inherited</option>
												<option value="Shared" <?php if($value->res_status == 'Shared') echo 'selected="selected"'; ?>>Shared</option>
												<option value="Purchased" <?php if($value->res_status == 'Purchased') echo 'selected="selected"'; ?>>Purchased</option>
												<option value="Rent" <?php if($value->res_status == 'Rent') echo 'selected="selected"'; ?>>Rent</option>
											<?php } ?>
										<?php } else{ ?>
							...
							<div class="form-group row">
								...
								<div class="col-lg-7 col-md-7 col-xs-12">
									<select name="age" id="residenceAge" class="form-control">
										<?php if ($residence != NULL ) { ?>
											<?php foreach ($residence as $value) { ?>
												<option value="1" <?php if($value->res_age == '1') echo 'selected="selected"'; ?>>1</option>
												<option value="2" <?php if($value->res_age == '2') echo 'selected="selected"';?>>2</option>
												<option value="3" <?php if($value->res_age == '3') echo 'selected="selected"'; ?>>3</option>
												<option value="4" <?php if($value->res_age == '4') echo 'selected="selected"';?>>4</option>
												<option value="5" <?php if($value->res_age == '5') echo 'selected="selected"';?>>5</option>
												<option value="6" <?php if($value->res_age == '6') echo 'selected="selected"'; ?>>6</option>
												<option value="7" <?php if($value->res_age == '7') echo 'selected="selected"'; ?>>7</option>
												<option value="8" <?php if($value->res_age == '8') echo 'selected="selected"'; ?>>8</option>
												<option value="9" <?php if($value->res_age == '9') echo 'selected="selected"'; ?>>9</option>
											<?php } ?>
										<?php } else{ ?>
											<option value="1">1</option>
											<option value="2">2</option>
							...
							<div class="form-group row">
								...
								<div class="col-lg-7 col-md-7 col-xs-12">
									<select name="Rating_scal" id="rating" class="form-control">
										<?php if ($residence != NULL ) { ?>
											<?php foreach ($residence as $value) { ?>
												<option value="1" <?php if($value->res_rating_scale == '1') echo 'selected="selected"'; ?>>1</option>
												<option value="2" <?php if($value->res_rating_scale == '2') echo 'selected="selected"'; ?>>2</option>
												<option value="3" <?php if($value->res_rating_scale == '3') echo 'selected="selected"'; ?>>3</option>
												<option value="4" <?php if($value->res_rating_scale == '4') echo 'selected="selected"'; ?>>4</option>
												<option value="5" <?php if($value->res_rating_scale == '5') echo 'selected="selected"'; ?>>5</option>
											<?php } ?>
										<?php } else{ ?>
											<option value="1">1</option>
											<option value="2">2</option>
	...
	<script>
		$(document).ready(function(){
			$('#uResidence').click(function(){
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url() ?>candidates/uResidence/'+id,
...
<script>
	$(document).ready(function(){
		$('#uHomeAsset').click(function(){
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url() ?>candidates/uHomeAsset/'+id,
		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php foreach ($invesCon as $investiCon) { ?>
					<textarea name="invesCon" id="inVesConclus" rows="5" class="form-control" placeholder="Please comment"><?php echo $investiCon->candidate_investigator_conclusion; ?></textarea>
				<?php } ?>
			</div>
		</div>
		<br>
...
<script>
	$(document).ready(function(){
		$('#invesCon').click(function(){
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url() ?>candidates/uInvestiCon/'+id,
...
///	}
  ...
  // 	$.ajax({
  // 		type: 'POST',
  // 		url: '<?php echo base_url() ?>candidates/uImage/'+id,
