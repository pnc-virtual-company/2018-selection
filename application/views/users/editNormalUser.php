       ...
       <div class="card">
         ...
         <div class="card-body">
          <!-- start form -->
            ...
            echo form_open('users/editNormalUser/' . $users_item['id'], $attributes);
            ?>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      <button id="submit" class="btn btn-primary"><i class="mdi mdi-pencil"></i>&nbsp;Update</button>
                      &nbsp;
                      <a href="<?php echo base_url();?>candidates" class="btn btn-danger"><i class="mdi mdi-cancel"></i>&nbsp;Cancel</a>
                  </div>
