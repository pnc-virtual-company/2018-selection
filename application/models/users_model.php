...
class Users_model extends CI_Model {
  ...
  public function getRoles($id = 0) {
    ...
    /**
     * Update a given user in the database. Updated data are coming from an HTML form
     * @return int number of affected rows
     * @author Benjamin BALET <benjamin.balet@gmail.com>
     */
    public function updateUsers() {
        // By default, the user is normal user
        $role = 2;
    ...
    /**
     * Update the session variables (used after a user modified his/ her profile)
     * @param $id of the user who has been updated
     */
    public function updateSession($id) {
        if ($this->session->id == $id){
            $newRole = $this->session->nameRole;
            //Check if there is a new role
            ...
            $newdata = array(
                ...
                'loginName' => $this->input->post('login'),
                'email' => $this->input->post('email'),
                'nameRole' => $newRole,
                'isAdmin' => $isAdmin,
                'user' => $user
