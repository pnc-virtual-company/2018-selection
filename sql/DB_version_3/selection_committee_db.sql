...
CREATE TABLE `skeleton_tbl_candidates` (
  ...
  `can_alternative1` varchar(45) COLLATE big5_bin DEFAULT NULL,
  `can_alternative2` varchar(45) COLLATE big5_bin DEFAULT NULL,
  `can_alternative3` varchar(45) COLLATE big5_bin DEFAULT NULL,
  `can_rank_1` varchar(45) COLLATE big5_bin DEFAULT NULL,
  `can_rank_2` varchar(45) COLLATE big5_bin DEFAULT NULL,
  `can_rank_3` varchar(45) COLLATE big5_bin DEFAULT NULL,
...
INSERT INTO `skeleton_tbl_candidates` (`can_id`, `can_firstname`, `can_lastname`, `can_gender`, `can_age`, `can_rank_inclass`, `can_healthy`, `can_pn_choic_rank`, `can_activity_achivement`, `can_resposibility`, `can_communicate`, `can_alternative1`, `can_alternative2`, `can_alternative3`, `can_rank_1`, `can_rank_2`, `can_rank_3`, `can_pnc_motivation`, `can_student_commit`, `can_parents_commit`, `can_global_grade`, `can_investigator_conclusion`, `can_ngo_comment`, `can_health_comment`, `can_images`, `pro_id`, `ngo_id`) VALUES
(1, 'dakhen', 'SOK', 'Male', 0, 1, 'Healthy', 1, 'I am an outstanding', '1', '1', NULL, NULL, NULL, NULL, NULL, NULL, '1', 'I commit to be a goodstudent', 'I commit to push my child to be a good student', 'A', NULL, NULL, '', NULL, 0, 1),
(6, 'Seav', 'AN', 'Male', 22, 10, 'Healthy', 1, 'I am not good student', '18/19', '1/20', 'ITC', 'RUPP', 'PNC', '2', '1', '3', '19/20', 'I commit to be a goodstudent', 'I commit to push my child to be a good student', 'Failed', NULL, NULL, '', NULL, 1, 8),
(7, 'vuthy', 'POUK', 'Female', 21, 10, 'Healthy', 2, 'I am an outstanding', '19', '13', 'Good ', 'Good ', 'Good ', '2', '2', '2', '19', 'I commit to be a goodstudent', 'I commit to push my child to be a good student', 'A+', 'She selected to study at pnc ', NULL, 'I never get sick early', NULL, 1, 1),
(8, 'dakhen', 'sok', 'Male', 20, 1, 'Healthy', 1, 'I am an outstanding', '19', '19', 'ITC', 'RUPP', 'PNC', '1', '1', '1', '19', 'I commit to be a goodstudent', 'I commit to push my child to be a good student', 'A+', NULL, NULL, '', NULL, 1, 10);
...
(3, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 120, 7);
...
(3, 112, 1, 1, 2, 1, 1, 1, 1, 12, 12, 12, 2, 2, 3, 111122, 2, 2, 2, 2, 2, 2, 1, 1, 2, 1, 1, 'I have a bit vehicles', 'I have an another animal ', 'I have a bit farm', 820, 57, 877, '2', NULL, 7);
...
(3, 12, 12, 12, 12, 374, 12, 12, 12, 12, 374, 748, 74.8, 7),
(4, 100, 100, 100, 100, 3116.6666666666665, 100, 100, 100, 100, 3116.6666666666665, 6233.333333333333, 445.23809523809524, 8);
...
(3, 12, 12, '12', 'I take for buy motobike', 12, 12, 12, 12, 7);
...
(3, 30, 'Farmer/Laborer', 'Healthy', '0', 20, 'Teacher', 'Healthy', '9', 4, NULL, 4, NULL, 7, 'dd', '', '', '', 9),
(4, 45, 'Farmer/Laborer', 'Healthy', '9', 45, 'Farmer/Laborer', 'Healthy', '11', 5, NULL, 3, NULL, 9, 'dd', 'Tailor', 'Good health', 'Good health', 7),
(5, 43, 'Soldier', 'Healthy', '10', 37, 'Other', 'Healthy', '10', 5, NULL, 4, NULL, 3, '', 'Tailor', '', '', 8);
...
(7, 'dakhen', 'SOK123', 'dakhen', 'dakhen.sok@student.passerellesnumeriques.org', '$2a$08$BeXOQ57xEe2nEfOjMKiriOCEegqoSwsma1vU.JKOzrVlF4WgXZNhC', 1, 1),
(8, 'dakhen', 'SOK', 'dakhen123', 'dakhen.sok@student.passerellesnumeriques.org', '$2a$08$vmAfSyQq2ceXMMoURwa5BucXrPA5A/VYPT8z6UeGCq0n8SKmASxNS', 2, 1);
